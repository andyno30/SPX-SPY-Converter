...
@app.route('/get_live_price_pro')  # Changed to match your endpoint
...
if __name__ == '__main__':
    port = int(os.environ.get("PORT", 10000))  # Reverted to your original default
    app.run(host='0.0.0.0', port=port)  # host='0.0.0.0' for Render compatibility
